...
class ListComponent extends React.Component {
  ...
  render() {
    return (
      <PageWrapper navBarText="List 列表" {...this.props}>
        <List renderHeader={() => "Basic Style"} className={style["my-list"]}>
          <Item extra={"extra content"}>Title</Item>
        </List>
        <List renderHeader={() => "Subtitle"} className={style["my-list"]}>
        ...
        <List renderHeader={() => "Text Wrapping"} className={style["my-list"]}>
