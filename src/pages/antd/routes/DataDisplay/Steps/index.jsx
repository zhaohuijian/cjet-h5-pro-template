...
const StepsComponent = (props) => {
  return (
    <PageWrapper navBarText="Steps 步骤条" {...props}>
      <WingBlank size="lg">
        ...
        <div className={style["sub-title"]}>Small size, single line text</div>
        <WhiteSpace />
        <Steps size="small" current={1}>
          <Step title="Finished" />
        ...
        <div className={style["sub-title"]}>Default size</div>
        <WhiteSpace size="lg" />
        <Steps>
          <Step
            status="process"
        ...
        <div className={style["sub-title"]}>Customized status </div>
        <WhiteSpace size="lg" />
        <Steps>
        ...
        <div className={style["sub-title"]}>Customized icon </div>
        <WhiteSpace size="lg" />
        <Steps current={1}>
          <Step
            title="Step 1"
        ...
        <div className={style["sub-title"]}> Multiple steps </div>
        <WhiteSpace size="lg" />
        <Steps current={1}>
