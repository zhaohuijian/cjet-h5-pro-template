...
const province = demoData.province;
...
class ListViewStickyIndex extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <PageWrapper
        navBarText="ListView 长列表 索引列表（标题吸顶） 下拉刷新"
        {...this.props}
      >
...
export default ListViewStickyIndex;
