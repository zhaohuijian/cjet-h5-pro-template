...
const district = demoData.district;
const provinceLite = demoData.provinceLite;
...
class PickerComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <PageWrapper navBarText="Picker 选择器" {...this.props}>
        <WhiteSpace size="lg" />
        <List
          style={{ backgroundColor: "white" }}
          className={style["picker-list"]}
        >
          <Picker
            extra="请选择(可选)"
            data={district}
...
export default createForm()(PickerComponent);
